...
// Регистратор панелей
		g740.panels={
			...
			registrate: function(panelName, builder) {
				...
				try {
					g740.trace.goStart(procedureName, {panelName: panelName, builder: builder});
			...
			getBuilder: function(panelName) {
				var result=null;
				var procedureName='g740.panels.getBuilder';
				try {
					g740.trace.goStart(procedureName, panelName);
...
//	objParent - родительская панель
			buildPanel: function(xml, objForm, objParent) {
				...
				try {
					g740.trace.goStart(procedureName, {xml: xml, objForm: objForm, objParent: objParent});
			...
			buildMenuBar: function (xml, objPanel) {
			    ...
			    try {
			        g740.trace.goStart(procedureName, { xml: xml, objPanel: objPanel });
			        if (!g740.xml.isXmlNode(xml)) g740.systemError(procedureName, 'errorValueUndefined', 'xml');
			...
			getRequestsDefa: function(objPanel) {
				...
				try {
					g740.trace.goStart(procedureName, {objPanel: objPanel});
					var result=[];
					if (!objPanel) g740.systemError(procedureName, 'errorValueUndefined', 'objPanel');
					var objForm=objPanel.objForm;
					if (!objForm) g740.systemError(procedureName, 'errorValueUndefined', 'objPanel.objForm');
			...
			buildToolbarMenuItem: function(xml, objPanel, objParent) {
				...
				try {
					g740.trace.goStart(procedureName, {xml: xml, objPanel: objPanel, objParent: objParent});
					if (!g740.xml.isXmlNode(xml)) g740.systemError(procedureName, 'errorValueUndefined', 'xml');
			...
			buildFldDef: function(xmlField, fldDef) {
				...
				try {
					g740.trace.goStart(procedureName, {xmlField: xmlField, fldDef: fldDef});
					if (!fldDef) fldDef={};
			...
			buildRequestParams: function(xmlRequest, request) {
				...
				try {
					if (this.isTraceEnabled) g740.trace.goStart(procedureName, {xmlRequest: xmlRequest, request: request});
		...
		dojo.declare(
			...
			dijit._Widget,
			{
				...
				constructor: function(para, domElement) {
					...
					try {
						g740.trace.goStart(procedureName);
						this.g740childs=[];
		...
		dojo.declare(
			...
			[dijit.layout.TabContainer, g740._PanelAbstract],
			{
				...
				constructor: function(para, domElement) {
					...
					try {
						g740.trace.goStart(procedureName, {para: para, domElement: domElement});
...
// Класс PanelWebBrowser
		dojo.declare(
			...
			[g740._PanelAbstract, dijit.layout.ContentPane],
			{
				...
				params: {},
				constructor: function(para, domElement) {
					var procedureName='g740.PanelWebBrowser';
					try {
						g740.trace.goStart(procedureName, {para: para, domElement: domElement});
						this.params={};
					}
...
// Класс PanelMemo
		...
		g740.panels._builderPanel=function(xml, para) {
			...
			try {
				g740.trace.goStart(procedureName, {xml: xml, para: para});
				if (!g740.xml.isXmlNode(xml)) g740.systemError(procedureName, 'errorValueUndefined', 'xml');
